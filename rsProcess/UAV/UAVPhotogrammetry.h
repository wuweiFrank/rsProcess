...
/*还是想做一套这样的工具出来用于摄影测量，IOPENCV的工具毕竟用于SFM的，用于摄影测量不太适用*/
...
public:
	...
	//7.设置相机内参数
	long UAVPhotogrammetryTools_SetParam(double len,double px0,double py0,double tk1,double tk2,double tr1,double tr2);
